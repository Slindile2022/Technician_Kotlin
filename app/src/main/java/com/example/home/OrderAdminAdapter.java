...
public class OrderAdminAdapter extends RecyclerView.Adapter<OrderAdminAdapter.HolderOderCustomer> implements Filterable {

    Context context;
    List<ModelOrderCustomer> orderCustomersList, filterList;


     FilterOrdersAdmin filter;

    public OrderAdminAdapter(Context context, List<ModelOrderCustomer> orderCustomersList) {
    ...
    public HolderOderCustomer onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.row_order_customer_for_admins, parent, false);
    ...
    public void onBindViewHolder(@NonNull HolderOderCustomer holder, int position) {
        ...
        holder.orderBy.setText("from : "+orderBy);
    ...
    public Filter getFilter() {
        if (filter == null){
            filter = new FilterOrdersAdmin(OrderAdminAdapter.this, filterList);
        }
        return filter;
    }
    ...
    class HolderOderCustomer extends RecyclerView.ViewHolder{
        ...
        // views of layout
        TextView orderIdTv, dateTv, amountTv, statusTv, technicianTv, orderBy;
