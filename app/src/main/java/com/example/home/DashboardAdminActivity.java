...
public class DashboardAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //on default you must see the products
                        ...
                        .setItems(Category.applianceCategory1, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (selected.equals("All")){
                                    ...
                                    adminProductAdapter = new AdminProductAdapter(DashboardAdminActivity.this, modelClassList);
        ...
        binding.messageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(DashboardAdminActivity.this, messages.class));
                            ...
                            .setItems(Category.orderFilter, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (selected.equals("All")){
                                        ...
                                        orderAdminAdapter = new OrderAdminAdapter(DashboardAdminActivity.this, modelOrderCustomerList);
